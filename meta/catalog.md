...
| RES-002-G-router | [영상 모드 판별기](../prompts/research/core/RES-002-G-router_mode_detector.md) `코어` / [어댑터](../prompts/research/adapters/RES-002-G-router_mode_detector.notebooklm.md) / [합본](../prompts/research/notebooklm/RES-002-G-router_mode_detector.notebooklm.md) | 영상 1편의 처리 모드(deep/brief/recipe) 추천 — 파이프라인 1단계 | 모드 판별 (추천만, 선택은 연구자) | F | draft | v1.0 (코어-어댑터) |
