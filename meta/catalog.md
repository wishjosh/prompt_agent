...
| RES-002-G | [영상 단일 소스 멀티모드 해체](../prompts/research/RES-002-G_video_deep_dive.md) | 영상 1편을 deep/brief/recipe 모드별로 해체 + 공통 척추(메타·글로사리·아티팩트·무근거주장) 유지 | 모드 추천, 비명시적 뼈대 재구성, 다중 화자 분리, 글로사리·아티팩트 추출 | F | draft | v2.0 |
